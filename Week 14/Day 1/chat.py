...
def sendchat():
    ...
    all_messages.append({"username": username,"message": message,"time": time})
    return {"username": username,"message": message,"time": time}
...
def register():
    ...
    all_accounts.append({"id": id, "password": password})
    print(all_accounts)
